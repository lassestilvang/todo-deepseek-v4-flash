...
export function useTaskCounts() {
  ...
  return { counts: counts || { total: 0, today: 0, upcoming: 0, next7Days: 0, overdue: 0, byList: {}, byLabel: {}, timeByList: {}, focusScore: 0, completedToday: 0, completedThisWeek: 0, streak: 0, weeklyCompletions: [] }, refresh };
}
